...
# MAX_LOOPS = 100        # the vehicle loop can abort after this many iterations, when given a positive integer.
# 
# #CAMERA
...
THROTTLE_REVERSE_PWM = 520      #pwm value for max reverse throttle
# 
...
#TRAIN_TEST_SPLIT = 20          #what percent of records to use for training. the remaining used for validation.
...
#MIN_DELTA = .00001               #early stop will want this much loss change before calling it improved.
#RINT_MODEL_SUMMARY = True      #print layers and weights to stdout
#OPTIMIZER = 'adam'                #adam, sgd, rmsprop, etc.. None accepts default
#LEARNING_RATE = 0.001           #only used when OPTIMIZER specified
#EARNING_RATE_DECAY = 0.0       #only used when OPTIMIZER specified
